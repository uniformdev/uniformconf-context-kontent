...
import { RegistrationForm as IRegistrationForm } from '../lib/contentTypes/registration_form';

export type RegisterProps = IRegistrationForm;

export function RegisterForm({ elements: { title, registeredText, buttonText } }: RegisterProps) {
        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <form>
              {registered ? (
                <>
                  <p className="pb-16">{registeredText.value}</p>
                  <Link href="/">
